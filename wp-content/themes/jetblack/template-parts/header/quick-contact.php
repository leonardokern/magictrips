	...
	<div class="inner-quick-contact">
		<ul>
			<?php if ( $jetblack_phone ) : ?>
				<li class="quick-call">
					<span><?php esc_html_e( 'Phone', 'jetblack' ); ?></span><a target="_blank" href="https://api.whatsapp.com/send?phone=<?php echo preg_replace( '/\s+/', '', esc_attr( $jetblack_phone ) ); ?>"><?php echo esc_html( $jetblack_phone ); ?></a> </li>
			<?php endif; ?>
